...
def merge_all_enrichments(movie_name):
    ...
    sem_emotions_file = f"outputs/scene_emotion/{movie_name}/{movie_name}_semantic_emotions.json"
    sem_emotions = {}
    ...
    audio_intel_file = f"outputs/scene_audio/{movie_name}/{movie_name}_audio_intelligence.json"
    audio_intel = {}
    ...
    for idx, scene in enumerate(scenes):
        ...
        if scene_id in sem_emotions:
            ...
            scene["viewer_emotion_prediction"] = sem.get("viewer_emotion_prediction", "")
        ...
        if scene_id in audio_intel:
            ...
            scene["background_music_mood"] = audio.get("background_music_mood", "unknown")
