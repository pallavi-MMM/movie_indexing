...
def merge_audio_intelligence(movie_name=None):
    ...
    audio_intel_file = (
        f"outputs/scene_audio/{target_movie}/{target_movie}_audio_intelligence.json"
    )
    ...
    for scene in scenes:
        ...
        scene["background_music_mood"] = audio_intel_scene.get(
        ...
        scene["audio_peaks_detected"] = audio_intel_scene.get(
        ...
        merged_count += 1
        print(
            f"  [{scene_id}] Merged audio intelligence: "
